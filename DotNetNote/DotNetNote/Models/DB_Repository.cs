...
namespace DotNetNote.Models
{
    public class DB_Repository
    {
        ...
        // Repository 나눠서 작업하지 않고 DB_Repository에 Notes/NotesCommet 클래스 함께 작업
        ...
        public int SaveOrUpdate(Note n, BoardWriteFormType formType)
        {
            ...
            switch (formType)
            {
                case BoardWriteFormType.Write:
                    ...
                    //저장프로시저로 시작 : 결과값은 1(저장 성공) or 0(저장 실패)
        ...
        public void Add(Note vm)
        {
            ...
            catch (System.Exception ex)
            {
                ...
                //throw new System.Exception(ex.Message); // 로깅 처리 권장 영역(nlog 사용할 것)
            }
        }
