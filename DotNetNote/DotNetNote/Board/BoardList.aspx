                ...
                <asp:GridView ID="GrvNotes" runat="server" AutoGenerateColumns="false" 
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="번호" 
                            HeaderStyle-Width="50px" ItemStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                                <%# Eval("Id")%>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText ="제목" 
                            HeaderStyle-Width="350px" ItemStyle-HorizontalAlign="Left">
                            <ItemTemplate>
                                ...
                                <%--새로 등록한 글 제목 옆에 new 이모티콘 생기게 하는 것--%>
                            </ItemTemplate>
                        </asp:TemplateField>
        ...
        <div class="row">
            <div class="col">
                <div class="text-right">
                    <a href="BoardWrite.aspx?Mode=Wirte" class="btn btn-primary">글쓰기</a>
                </div>
            </div>
        </div>
    </div>
